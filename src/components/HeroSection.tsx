  ...
  return (
    <section className="relative min-h-[600px] bg-gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <img 
          src={ganpatiHero} 
          alt="Ganpati Festival Special Offer" 
      ...
      <div className="relative container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <h1 className="font-heading text-5xl md:text-7xl mb-6 leading-tight">
            ...
            <span className="text-2xl md:text-3xl font-normal block mt-4">
              Limited Time!
            </span>
          </h1>
          ...
          <p className="text-xl md:text-2xl mb-8 font-body opacity-90">
            या मासूमध्ये ज्ञानाची खरी खास सवलतींचा वर्षाव!
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="hero" 
              size="lg" 
              className="text-xl px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              View Courses
            </Button>
            <Button 
